...
public class Base {
	...
	public static ExcelReader excel = new ExcelReader(System.getProperty("user.dir") + "\\src\\test\\resources\\excel\\formData.xlsx");
	...
	@BeforeSuite
	@Parameters({"deviceType","appName","realDevice","emulator"})
	public static void setUp(@Optional("emulator") String deviceType, String appName, String realDevice, String emulator) throws MalformedURLException{
		...
		if(deviceType.equals("realDevice")) {
			...
			cap.setCapability(MobileCapabilityType.APP,"cloud:com.GamesForKids.Mathgames.MultiplicationTables/.SplashScreenActivity");
			cap.setCapability("instrumentApp", true);
			cap.setCapability(MobileCapabilityType.FULL_RESET, true);
			cap.setCapability("dontGoHomeOnQuit", true);
			cap.setCapability("appBuildVersion", "84");
			cap.setCapability("appReleaseVersion", "8.4");
	         ...
	         *
	         * URL remoteUrl = new URL("https://cloud.seetest.io/wd/hub"); driver = new
	         * AndroidDriver(remoteUrl, dc);
	         */
		}
		else
